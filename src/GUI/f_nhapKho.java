 ...
 * @author admin
 */
public class f_nhapKho extends javax.swing.JFrame {

    /**
     * Creates new form fDanhSach_NhapHang
     */
    
    public f_nhapKho(int id_nv) {
        initComponents();
        setIcon();
//        this.id_nv = id_nv;
...
//        ThongBao.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_nhapKho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new f_nhapKho(1).setVisible(true);
            }
        });
    }
