 ...
 * @author VIENTHONGA
 */
public class f_ViewNhanVien extends javax.swing.JFrame {
...
//    public static int id;  t9999
    public f_ViewNhanVien() {
        initComponents();
        setIcon();
    }
    public f_ViewNhanVien(int id_nv) {
        this.id_nv=id_nv;
//        this.id=id;t9999
        initComponents();
        setIcon();
    ...
    public void ShowNhanVien(int id_nv)
    {
        NhanVien nv = DAO.daoTaiKhoan.getInstance().getNhanVien(id_nv);//t9999
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_ViewNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new f_ViewNhanVien(id_nv).setVisible(true);
            }
        });
    }
