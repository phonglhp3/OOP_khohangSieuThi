 ...
 * @author admin
 */
public class f_HoanThanhNhapHang extends javax.swing.JFrame {
...
//        TrangChu.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_HoanThanhNhapHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new f_HoanThanhNhapHang().setVisible(true);
            }
        });
    }
