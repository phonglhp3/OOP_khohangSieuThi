 ...
 * @author admin
 */
public class f_ChonNhaCungCapNhapHang extends javax.swing.JFrame {
    ...
    public f_ChonNhaCungCapNhapHang(int id_nv,int id_sp) {
        initComponents();
        setIcon();
        this.id_nv =id_nv;
        this.id_sp = id_sp;
    ...
    public f_ChonNhaCungCapNhapHang() {
        initComponents();
        setIcon();
    }
    ...
    public void build(){
//        listNguonCungCap(); t9999
        String sql="select id_cc, ten_nha_CC, sdt from nguon_cc;";
...
//        TrangChu.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_ChonNhaCungCapNhapHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new f_ChonNhaCungCapNhapHang(f_DangNhap.id_nv,1).setVisible(true);
            }
        });
    }
