 ...
 * @author heheh
 */
public class f_baoCao extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_baoCao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
